...
class VectorQuantizer(nn.Module):
    ...
    def __init__(self, n_e, e_dim, weight_path=None, beta=0.25, LQ_stage=False, use_weight=True, weight_alpha=1.0):
        super().__init__()
        self.n_e = int(n_e)
...
class VQWeightDehazeNet(nn.Module):
    def __init__(self,
        ...
        self.use_warp = use_warp
        self.weight_alpha = weight_alpha
        self.matching_weight_path = matching_weight_path
        ...
        for scale in range(0, codebook_params.shape[0]):
            quantize = VectorQuantizer(
                ...
                weight_path=self.matching_weight_path,
