...
def inference(model, args):
    ...
    input_img_path = "./test_images/test/defocus deblurring.png"
    ...
    with torch.no_grad():
        ...
        pred_clip += 0.5 / 255  # 量化补偿

        # 保存图片
        save_name = os.path.join(args.result_dir, "defocus_deblurring_result.png")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='./EVSSM/test_images')
    # Test
    parser.add_argument('--test_model', type=str, default='./ckpts/net_g_GoPro.pth')
